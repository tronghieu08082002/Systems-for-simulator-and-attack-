...
class TopicEnumerationAttackTLS:
    ...
    def create_client(self, client_id, username=None, password=None):
        try:
            ...
            # Logic TLS chỉ sử dụng CA Certificate
    ...
    def enumeration_worker(self, worker_id, topic_candidates, delay_ms=200, username=None, password=None):
        ...
        try:
            ...
            client.loop_start()
            # Tính toán thời gian lắng nghe dựa trên số lượng topic
    ...
    def launch_attack(self, num_workers=2, delay_ms=200, custom_topics=None, username=None, password=None):
        ...
        print(f"\n Starting Topic Enumeration Attack (TLS - CA Hardcoded)")
        ...
        threads = []
        # Chia danh sách topic cho các worker
...
def main():
    parser = argparse.ArgumentParser(description="MQTT Topic Enumeration Attack (TLS CA Only)")
