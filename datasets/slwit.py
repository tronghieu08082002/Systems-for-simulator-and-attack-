...
usage: python slwit.py --host <IP> --clients 5 --idle 30 [To test "Short" connections (Original behavior)]
       python slwit.py --host 10.12.112.191 --clients 50 --zombie --tls --ca-file ./certs/ca-cert.pem --username giamdoc --password 123 [To test "Zombie" connections (New behavior)]
"""
...
def main():
    parser = argparse.ArgumentParser(description="SlowITe Attack Simulator for IDS Testing")
    ...
    # NOTE: kalive arguments removed because we hardcoded it to 65535
